...
base = alt.Chart(resumen).encode(
    ...
    title='Etapas',
    scale=alt.Scale(
        domain=["Por Elaborar", "Por Conciliar", "Pendiente de Pedido", "Pedido Recibido", "Sin clasificar"],
        range=["#60A5FA", "#1D4ED8", "#EF4444", "#86EFAC", "#9CA3AF"]  # rojo pendiente, verde claro recibido
    )
),
